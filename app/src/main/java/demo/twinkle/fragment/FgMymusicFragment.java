...
import demo.com.mobileplayer.utils.ActivitySkipUtil;
import demo.twinkle.activity.EditSonglistActivity;
import demo.twinkle.activity.ManageSonglistActivity;
import demo.twinkle.activity.ShareSonglistActivity;
import demo.twinkle.adapter.SongListAdapter;
import demo.twinkle.bean.SongList;

//TODO 本地音乐
public class FgMymusicFragment extends Fragment implements SongListAdapter.InnerItemOnclickListener, OnItemClickListener{
    ...
    private TextView local_music_title;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        local_music_title =mymusicView. findViewById(R.id.local_music_title);
        local_music_title.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
               PlayerMainActivity.startPlayerMainActivity(FgMymusicFragment.this.getContext(),"local_audio");
            }
        });
