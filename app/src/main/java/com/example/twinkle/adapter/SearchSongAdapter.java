...
public class SearchSongAdapter extends ArrayAdapter<Song> implements View.OnClickListener {
    private List<Song> songList;
    public InnerItemOnclickListener mListener;
    private int resourceId;

    public SearchSongAdapter(Context context, int textViewResourceId, List<Song> objects){
    ...
    public View getView(int position,View convertView,ViewGroup parent){
        ...
        if (convertView == null) {
            ...
            viewHolder.search_song_operate =  view.findViewById (R.id.search_song_operate);
